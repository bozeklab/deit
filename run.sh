...
# CHECK IF THIS WILL TRAIN WELL
#python main.py --sample_divisions --resume /home/jano1906/git/deit/deit_finetune_wsampling_immagenet1k2/checkpoint.pth --output_dir deit_finetune_wsampling_immagenet1k2 --model deit_small_patch16_LS --data-path /home/jano1906/datasets/imagenet/ILSVRC/Data/CLS-LOC --batch 256 --lr 1e-6 --epochs 10 --weight-decay 0.05 --sched cosine --input-size 224 --eval-crop-ratio 1.0 --reprob 0.0 --smoothing 0.0 --warmup-epochs 5 --drop 0.0 --seed 0 --opt adamw --warmup-lr 1e-6 --mixup .8 --drop-path 0.05 --cutmix 1.0 --unscale-lr --repeated-aug --bce-loss  --color-jitter 0.3 --ThreeAugment

python main.py --sample_divisions --finetune /home/jano1906/git/deit/checkpoints/deit_3_small_224_1k.pth --output_dir deit_finetune_wsampling_imagenet1k2 --model deit_small_patch16_LS --data-path /home/jano1906/datasets/imagenet/ILSVRC/Data/CLS-LOC --batch 256 --lr 1e-6 --min-lr 1e-6 --epochs 20 --weight-decay 0.05 --sched cosine --input-size 224 --eval-crop-ratio 1.0 --reprob 0.0 --smoothing 0.0 --warmup-epochs 5 --drop 0.0 --seed 0 --opt adamw --warmup-lr 1e-6 --mixup .8 --drop-path 0.05 --cutmix 1.0 --unscale-lr --repeated-aug --bce-loss  --color-jitter 0.3 --ThreeAugment

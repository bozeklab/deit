...
if __name__ == '__main__':
    ...
    for kappa in range(0, 13):
        train_path = f"/data/pwojcik/deit/dino_tore_in1k_train_p16/extract_k16/{kappa}_16.npz"
        test_path = f"/data/pwojcik/deit/dino_tore_in1k_val_p16/extract_k16/{kappa}_16.npz"
